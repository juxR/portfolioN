...
<body>
        <!--[if lt IE 7]>
            ...
            <![endif]-->
            <h1 aria-level="1" role="heading" class="section">Page de l'article: Découverte de Modernizr</h1>
            <?php include('nav.php'); ?>
            <section role="main" id="main" class="main">
                <h2 aria-level="2" role="heading" class="section">Partie principale de la page</h3>
                    <section>
                       <h4 class="section" role="heading" aria-level="4">Les articles que j'ai postés</h4>
                       <article itemscope itemtype="http://schema.org/BlogPosting" class="listBlog wrapper">
                        ...
                        <div itemprop="text" class="article">
                            ...
                            <span class="date">Posté le <time  datetime="" date="2013-10-28" itemprop="datePublished">Mardi 28 Octobre</time></span>
                            <p>
